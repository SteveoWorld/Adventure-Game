...
namespace Adventure_Game
{
    public class World
    {
        ...
        public bool ChangeLocation()
        {
            ...
            int userChoice = 0;
            string userInput = Utility.GetUserInput("Where to my wise friend :) ?");
        ...
        public void Menu()
        {
            ...
            Console.WriteLine($"Welcome {CurrentPlayer.Name} to the world of {Name}. " +
                $"\n\n Many years ago, On a cloudy mystic day, near mountains comes across the kingdom of peaceful and dispassionate citizens.There once comes a huge cloud Of black smoke summoning A human - like shadowy figure named Ophelia."   +
                $"\nCausing havoc in the kingdom! Only You {CurrentPlayer.Name} can stop her. Good Luck! To see the commands you can use type the word 'help' and hit enter. To enter other commands type in the command and hit enter." +
                ...
                switch (ReadLine().ToLower().Trim())
                {
                    ...
                    case "talk":
                        ...
                        if (CurrentPlayer.CurrentLocation.Guardian != null)
                        {
                            ...
                            //Gets the player's choice for item to sell
                        ...
                        {
                            WriteLine("There are no gods here");
                        }
                        break;
                    case "search":
                    ...
                    case "help":
                        ...
                        {
                            WriteLine("Available Commands: Inventory, Talk, Search, Clear, Move, Win (you can only do this when you defeat Ophelia), Quit (you don't want to do this)");
                        }
                        break;
                    ...
                    case "win":
                        ...
                        {
                            WinTheGame = true;
                            WriteLine($"Hooray you are the LEADER of the KINGDOM SWEET SWEET VICTORY  and YOU won the game. Press any key to close the console");
                            ReadKey();
                        }
                        else
                        {
                            WriteLine("You haven't killed the main boss yet which makes me sad");
                        }
                        break;
                    ...
                    case "lose":
                        ...
                        {
                            WinTheGame = false;
                            WriteLine($"You bought the tiny DaGgEr!!!!?!");
                            ReadKey();
                            Console.Clear();
